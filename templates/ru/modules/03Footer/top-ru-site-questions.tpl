<div id="container">
   <div class="chat_header">
       <div>
           <button class="chat_icon">
               ...
               <span> Вопросов и предложений </span>
           </button>
           <div id="wait_helper">
   ...
   <main id="chat_item">
       <div id="no_chat">
           <div>
               <span> Используйте этот раздел, чтобы получить ответы на свои вопросы и предложения. Заполните свой личный номер телефона и имя, по которому наши операторы свяжутся с вами для улучшения качества обслуживания! </span>
           </div>
