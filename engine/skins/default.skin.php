...
/*
=====================================================
 AVIMEDA GROUP - by Media Group 
-----------------------------------------------------
 http://dle-news.ru/
-----------------------------------------------------
 Copyright (c) 2022 Media Group
=====================================================
...
if ($is_loged_in) {
	...
	while ( $row = $db->get_array() ) {
		...
		if ( count(explode("@", $row['foto'])) == 2 ) {
			...
			} else $pm_avatar = "engine/skins/images/monomarkaz-avatar.png";
...
HTML;
	...
	if ( count(explode("@", $member_id['foto'])) == 2 ) {
		...
		} else $avatar = "engine/skins/images/monomarkaz-avatar.png";
	}
...
<html>
<head>
	<link type="image/x-icon" href="engine/skins/images/favicon.ico" rel="shortcut icon">
	<meta charset="utf-8">
	<title> «MONOMARKAZ.UZ» — ISHGA MARHAMAT - {$lang['skin_title']}</title>
...
//-->
	...
	<div class="navbar navbar-inverse bg-primary-700">
		<div class="navbar-header">
			<a class="navbar-brand" href="?mod=main"><i class="fa fa-medium" style="font-size: 40px;"></i>ONOMARKAZ.UZ </a>
					...
					<div class="sidebar-user-material">
						<div class="category-content">
							...
							<div class="sidebar-user-material-menu">
								<a href="#user-nav" data-toggle="collapse"><span><i class="fa fa-buysellads" style="margin-right: 15px;"></i>{$lang['account']}</span> <i class="caret"></i></a>
							</div>
						</div>
						<div class="navigation-wrapper collapse" id="user-nav">
							<ul class="navigation">
								...
								<li><a href="?action=logout"><i class="fa fa-sign-out text-danger-800"></i> <span>{$lang['skin_logout']}</span></a></li>
							</ul>
						</div>
					</div>
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4 style="font-weight: 600;"><i class="fa fa-buysellads" style="font-size: 25px;"></i>дминистративный панель сайта! </h4>
						</div>
...
$skin_footer = <<<HTML
					<div class="footer text-muted text-size-small">
						 <a href="https://monomarkaz.uz/uz/" target="_blank"> «MONOMARKAZ.UZ» — ISHGA MARHAMAT </a> Copyright 2022 &copy; Все права защищены.
					</div>
				</div>
			</div>
		</div>
...
<head>
	<link type="image/x-icon" href="engine/skins/images/favicon.ico" rel="shortcut icon">
	<meta charset="utf-8">
	<title> «MONOMARKAZ.UZ» — Войти</title>
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<meta name="HandheldFriendly" content="true">
	<meta name="format-detection" content="telephone=no">
	<meta name="viewport" content="user-scalable=no, initial-scale=1.0, maximum-scale=1.0, width=device-width"> 
...
<body class="no-theme" style="background-image: url(engine/skins/images/background-image.jpg);background-repeat: no-repeat;background-size: cover;">
<script>
<!--
var dle_act_lang   = [];
...
<!--MAIN area-->
	...
	<div class="panel panel-default" style="margin-top: 50%;">
		...
		<div class="panel-heading">
			<link type="image/x-icon" href="engine/skins/images/favicon.ico" rel="shortcut icon">
			<img src="engine/skins/images/favicon.png" style="text-align: center;text-align: center;width: 60%;margin: 10% 20%;">
		</div>

		<div class="panel-body" style="border-bottom-right-radius: 10px;border-bottom-left-radius: 10px;background-color: #fff;">
	...
	<!--<div class="text-muted text-size-small text-center"> <a href="https://monomarkaz.uz/uz/" target="_blank"> «MONOMARKAZ.UZ» — ISHGA MARHAMAT </br> </a> Copyright 2022 &copy; Все права защищены.</div>-->
