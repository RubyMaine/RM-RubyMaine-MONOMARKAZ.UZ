		...
		<div class="panel panel-default">
		    ...
		    <div class="panel-heading">
				<ul class="nav nav-tabs nav-tabs-solid">
					<li class="active"><a href="#statall" data-toggle="tab"><i class="fa fa-medium position-left"></i> {$lang['stat_all']}</a></li>
					<li id="dlestats"><a href="#statauto" data-toggle="tab"><i class="fa fa-medium position-left"></i> {$lang['stat_auto']}</a></li>
				</ul>
			</div>
				...
				<div class="panel-tab-content tab-content">
					<div class="tab-pane active" id="statall">
						...
						<table class="table table-sm">
							<tr>
								<td style="width: 360px;" >{$lang['site_status']}</td>
								<td>{$offline}</td>
							</tr>
							<tr>
...
HTML;
	...
	echo "<button id=\"clearbutton\" name=\"clearbutton\" class=\"btn bg-danger-600 btn-sm btn-raised\"><i class=\"fa fa-trash\"></i> {$lang['btn_clearcache']}</button>";
...
echo <<<HTML
                     ...
                     <div class="tab-pane" id="statauto" >
						<table class="table table-sm">
							<tr>
								<td style="width: 360px;">{$lang['licence_info']}</td>
								<td>{$licence}</td>
							</tr>
							<tr>
								<td>{$lang['stat_os']}</td>
